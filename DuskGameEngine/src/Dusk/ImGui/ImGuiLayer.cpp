...
#include"imgui.h"
//TODO: After final implemetation remove header from project
...
namespace Dusk
{
	...
	void ImGuiLayer::OnAttach()
	{
		...
		//Temporary keymap for ImGui eventually should impelement Dusk keycodes
	...
	void Dusk::ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<KeyReleasedEvent>(DK_BIND_EVENT_FN(ImGuiLayer::OnKeyReleaseEvent));
	...
	bool ImGuiLayer::OnWindowResizeEvent(WindowResizeEvent& e)
	{
		...
		glViewport(1, 1, e.GetWidth(), e.GetWidth());
